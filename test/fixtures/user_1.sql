/* user */
INSERT INTO commercial (id, lastname, name, birthdate, email, creation_date)
...
ON CONFLICT DO NOTHING;
/* expense_report */
INSERT INTO expense_report (id, amount, type, company, commercial, payment_date, creation_date)
